...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.2"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.2"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.2"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.2` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.2` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.2` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.2" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.2" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.2"
```

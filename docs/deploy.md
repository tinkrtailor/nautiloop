...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.4.6"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.4.6"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.4.6"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.4.6` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.4.6` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.4.6` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.4.6" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.4.6" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.4.6"
```

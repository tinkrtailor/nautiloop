...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.3.7"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.3.7"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.3.7"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.3.7` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.3.7` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.3.7` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.3.7" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.3.7" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.3.7"
```

...
variable "control_plane_image" {
  ...
  type        = string
  default     = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.2"
}

variable "agent_base_image" {
  description = "Agent base container image"
  type        = string
  default     = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.2"
}

variable "sidecar_image" {
  description = "Auth sidecar container image"
  type        = string
  default     = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.2"
}
